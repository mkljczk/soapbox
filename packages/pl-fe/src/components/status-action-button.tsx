  ...
  return (
    <button
      ...
      className={clsx(
        ...
        {
          'text-gray-600 hover:text-gray-800 dark:hover:text-white fill-gray-600 hover:fill-gray-800 dark:hover:fill-white bg-transparent hover:bg-primary-100 dark:hover:bg-primary-800 black:hover:bg-gray-800': theme === 'default',
          ...
          'text-success-600 hover:asuccess-600 dark:hover:text-success-600': active && !emoji && color === COLORS.success,
          'space-x-1': !text,
          'space-x-2': text,
        },
        className,
